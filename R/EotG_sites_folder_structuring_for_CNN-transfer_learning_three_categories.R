## ------------------------------------------ ##
## Paper 2. Dataset creation three categories
...
lb_info$damage_extent <- cut(x = lb_info$extent, breaks = c(0,30,60,100), labels = c('low','medium','high'), include.lowest = T, right = F)
...
pth <- paste0('D:/pbi_smpl_categorical') # Output directory
